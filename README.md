...
Injected Corrections: The smartphone feeds these RTCM messages back to the UM981 using a physical USB-to-serial cable.Bluetooth Output: At the same time, RaceChrono receives the translated, INS-enhanced NMEA coordinates wirelessly from the ESP32 via Bluetooth.
